        ...
        try
        {
            ...
            do
            {
                ...
                if(level == 1)
                {
                    ...
                    {
                        // create player objects
                        System.out.println("You choose Cross 'X'");
                        human.setMarker("X");
                        computer.setMarker("O");
                    } 
                    else if(marker == 2)
                    {
                        System.out.println("You chose Nought 'O'");
                        human.setMarker("O");
                ...
                else if(level == 2)
                {
                    ...
                    {
                        // create player objects
                        System.out.println("You chosoe cross 'X'");
                        human.setMarker("X");
                        computer.setMarker("O");
                    } 
                    else if(marker == 2)
                    {
                        System.out.println("You choose Nought 'O'");
                        human.setMarker("O");
                        computer.setMarker("X");
                    }
                    else if((marker != 1) && (marker != 2))
